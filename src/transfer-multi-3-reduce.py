...
from vdcnn_multi_3 import MultiVDCNN, VDCNN
...
n_topic = 100
iteration = 75000
premodel = MultiVDCNN(len(char2id)+1, 20, n_topic, 200, depth)
serializers.load_npz('../results/multi3_softtopic_{}_20_{}_200_depth{}_valid{}/model_iteration-{}'.format(mode, n_topic, sum(depth)*2+1, args.valid, iteration), premodel)
...
result_dir = '../results/multi3_transfer_soft_{}_20_{}_200_{}_depth{}_reduce{}_valid{}'.format(mode, n_topic, iteration, sum(depth)*2+1, args.reduce, args.valid)
