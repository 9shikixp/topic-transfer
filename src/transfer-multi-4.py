...
from vdcnn_multi_4 import MultiVDCNN, VDCNN
...
iteration = 75000
premodel = MultiVDCNN(len(char2id)+1, 20, 100, 200, n_topic, depth)
serializers.load_npz('../results/multi4_softtopic_{}_20_100_200_{}_depth{}_valid{}/model_iteration-{}'.format(mode, n_topic, sum(depth)*2+1, args.valid, iteration), premodel)
...
result_dir = '../results/multi4_transfer_soft_{}_20_100_200_{}_{}_depth{}_valid{}'.format(mode, n_topic, iteration, sum(depth)*2+1, args.valid)
